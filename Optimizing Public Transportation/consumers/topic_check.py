...
def topic_pattern_match(pattern):
    ...
    """
    client = AdminClient({"bootstrap.servers": "PLAINTEXT://localhost:9092"})                # added as per suggestion https://hub.udacity.com/rooms/community:nd029:899653-project-640/community:thread-11475108585-2649811?contextType=room
